...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
                                ...
                                <table className="w-full border-collapse border-2 border-gray-300 rounded-lg overflow-hidden" style={{tableLayout: 'fixed'}}>
                                  <thead>
                                    <tr className="bg-gray-100">
                                      ...
                                      <th className="px-3 py-2 text-center text-sm font-semibold align-top" style={{width: '26%', wordBreak: 'normal', hyphens: 'auto'}}>Student'sChromebooks</th>
        ...
        <div className="bg-gradient-to-r from-red-500 to-pink-600 rounded-xl shadow-lg p-8 text-white">
          ...
          <div className="bg-white bg-opacity-10 rounded-lg p-6">
            ...
            <br />
            <p className="leading-relaxed">As part of the BYOAD programme, Chromebooks have been provided by Beaconhouse to the teachers Grade 5 to 8, Pearson and Well-being Counselors, excluding P.E, Music, and Sindhi,.</p>
            <br />
      ...
      {/* Tool Detail Modal */}
      {selectedTool && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" style={{alignItems: 'center', justifyContent: 'center'}}>
