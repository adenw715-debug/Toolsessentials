...
const gradeLevels: GradeLevel[] = [
  {
    ...
    tools: {
      ...
      "USB Computer Headset": "6 per section"
    }
  },
  {
    ...
    tools: {
      "Netbooks/Chromebooks": "5 per section",
      "MMPs": "1 per section",
      "Speakers": "1 per section",
      "COW": "25 Netbooks per COW"
    }
  },
  {
    ...
    tools: {
      "MMPs": "1 per section",
      "Speakers": "1 per section",
      "Netbooks/Chromebooks": "For class 5 as per BYOAD plan"
    }
  },
  {
    ...
    tools: {
      "MMPs": "1 per section",
      "Speakers": "1 per section",
      "Netbooks/Chromebooks": "As per BYOAD plan"
    }
  },
  {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700">Students should not use Tablets/Netbooks without teacher supervision.</p>
              </div>
              <div className="flex items-start space-x-3">
